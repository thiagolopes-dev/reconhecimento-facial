...
# Inicializa a variável descritor_referencia fora do loop
...
while True:
    ...
    # Inicializa as variáveis para o reconhecimento
    nome_pessoa_reconhecida = "Desconhecido"
    percentual_acertividade = 0.8

    for face in faces_detectadas:
        # Obtém os pontos faciais do quadro
        pontos_faciais = modelo_pontos_faciais(frame_rgb, face)

        # Calcula os descritores faciais do quadro
        ...
        # Define um limite de similaridade mais flexível
        limite_similaridade = 0.6  # Ajuste esse valor conforme necessário
        ...
        # Prepara o texto para exibição (nome da pessoa e percentual de acertividade)
        ...
        # Exibe o nome da pessoa reconhecida e o percentual de acertividade em verde sobre o fundo preto
    ...
    # Atualiza o descritor de referência para o próximo quadro
    descritor_referencia = modelo_reconhecimento.compute_face_descriptor(imagem_referencia_rgb, pontos_referencia)
